import 'bloc/list_task_bloc.dart';
import 'models/list_task_model.dart';
import 'package:dolistoapp/core/app_export.dart';
import 'package:dolistoapp/widgets/app_bar/appbar_image.dart';
import 'package:dolistoapp/widgets/app_bar/appbar_subtitle.dart';
...
class ListTaskScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<ListTaskBloc>(
        create: (context) =>
            ListTaskBloc(ListTaskState(listTaskModelObj: ListTaskModel()))
              ..add(ListTaskInitialEvent()),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ListTaskBloc, ListTaskState>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
              appBar: CustomAppBar(
                  leadingWidth: 38.h,
