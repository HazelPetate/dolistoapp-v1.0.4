import 'bloc/finished_tasks_bloc.dart';
import 'models/finished_tasks_model.dart';
...
class FinishedTasksScreen extends StatelessWidget {
  const FinishedTasksScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<FinishedTasksBloc>(
      create: (context) => FinishedTasksBloc(FinishedTasksState(
        finishedTasksModelObj: FinishedTasksModel(),
      ))
        ..add(FinishedTasksInitialEvent()),
      child: FinishedTasksScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<FinishedTasksBloc, FinishedTasksState>(
